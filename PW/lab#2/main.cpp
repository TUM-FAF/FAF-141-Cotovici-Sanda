                     ...
                     int nCmdShow)
{
    ...
    hwnd = CreateWindowEx (
           ...
           _T("Windows Programming #2"),       /* Title Text */
           WS_OVERLAPPEDWINDOW | WS_VSCROLL | WS_HSCROLL, /* default window */
           410,       /* Windows decides the position */
           180,       /* where the window ends up on the screen */
...
LRESULT CALLBACK WindowProcedure (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (message)                  /* handle the messages */
    {
        ...
        case WM_CONTEXTMENU:
        {
            ...
            {
                if(MessageBox(hwnd, "Do you want to delete this item?", "Warning!!!", MB_YESNO) == IDYES)
                {
